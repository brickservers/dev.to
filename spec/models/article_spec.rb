  ...
  describe "validations" do
    ...
    describe "#after_commit" do
      ...
      it "on update syncs elasticsearch data" do
        allow(article).to receive(:sync_related_search_docs)
        article.save
        expect(article).to have_received(:sync_related_search_docs)
      end
    end
    ...
    describe "#after_update_commit" do
      ...
      it "indexes reaction if a REACTION_INDEXED_FIELDS is changed" do
        reaction = create(:reaction, reactable: article, category: "readinglist")
        allow(article).to receive(:index)
        allow(article.user).to receive(:index)
